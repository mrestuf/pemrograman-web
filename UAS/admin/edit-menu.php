<?php 
  ...
  $query = "SELECT * FROM tbproduk WHERE id_produk = '$id_produk' LIMIT 1";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="update-menu.php" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                            <label class="form-label" for="id_produk">Id Produk</label>
                                <input type="text" name="id_produk" value="<?= $row['id_produk']?>"
                            ...
                            <label class="form-label" for="gambar_produk">Gambar Produk</label>
                                <input type="file" name="gambar_produk" value="<?= $row['gambar_produk']?>"
                                    class="form-control form-control-lg" />
