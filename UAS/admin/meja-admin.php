...
$dmejaQuery = "SELECT * FROM tbmeja";

$dmejaData = mysqli_query($koneksi, $dmejaQuery);
?>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="meja-admin.php"><i class="fa fa-circle-o"></i> Data Meja</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="box">
                            ...
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                <div class="input-group-btn">
                                    <button type="submit" class="btn btn-default"><a
                                            href="/10519100/UAS/admin/input-meja.php"><i
                                                class="fa fa-plus-square"><strong> Tambah Data
                                                    Meja</strong></i></a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-hover">
                            <tr>
                                <th width="45%">No Meja</th>
                                <th width="45%">Kapasitas Meja</th>
                                <th width="10%">Aksi</th>

                            </tr>
                            <?php while($dmeja = mysqli_fetch_assoc($dmejaData)){ ?>
                            <tr>
                                <td><?= $dmeja['no_meja'] ?></td>
                                <td><?= $dmeja['kapasitas_meja'] ?></td>
                                <td><a class="btn btn-default btn-block btn-flat"
                                        href="/10519100/UAS/admin/edit-meja.php?no_meja=<?= $dmeja['no_meja'] ?>">
                                        <i class="fa fa-edit"> Edit</i>
                                    </a>
                                    <a class="btn btn-danger btn-block btn-flat"
                                        href="/10519100/UAS/admin/delete-meja.php?no_meja=<?= $dmeja['no_meja'] ?>">
