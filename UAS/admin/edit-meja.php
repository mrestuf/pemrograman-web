<?php 
  ...
  $query = "SELECT * FROM tbmeja WHERE no_meja = '$no_meja' LIMIT 1";
            ...
            <section class="content">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Data Meja</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="update-meja.php" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                            <label class="form-label" for="no_meja">Nomor Meja</label>
                                <input type="text" name="no_meja" value="<?= $row['no_meja']?>"
                                    class="form-control form-control-lg" />
                                
                            </div>
                            <div class="form-group">
                            <label class="form-label" for="kapasitas_meja">Kapasitas Meja</label>
                                <input type="text" name="kapasitas_meja" value="<?=$row['kapasitas_meja']?>"
                                    class="form-control form-control-lg" />
